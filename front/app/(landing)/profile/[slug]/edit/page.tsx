...
export default function EditProfilePage() {
  ...
  const avatarUrl = user?.avatar || "/placeholder.svg"
          ...
          <div className="border border-border-color rounded-xl bg-white shadow-subtle p-6 sm:p-8 relative">
            <div className="flex flex-col sm:flex-row items-start gap-6 mb-8">
              <div className="relative shrink-0">
                <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full h-24 w-24 sm:h-28 sm:w-28" style={{ backgroundImage: `url(${avatarUrl})` }} />
                <button type="button" className="absolute bottom-0 right-0 flex items-center justify-center h-8 w-8 rounded-full bg-primary text-white hover:bg-primary-dark transition-colors border-2 border-white">
