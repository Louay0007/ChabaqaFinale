...
import ProductList from "@/app/(community)/[slug]/(loggedUser)/products/components/product-list"
import ProductDetailsSidebar from "@/app/(community)/[slug]/(loggedUser)/products/components/product-details-sidebar"
