...
import { TemplateSelector } from "@/app/(dashboard)/components/template-selector"
import { PreviewModal } from "@/app/(dashboard)/components/preview-modal"
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                  ...
                  <TabsContent value="design" className="p-6 sm:p-8 space-y-8">
                    ...
                    <div className="space-y-4">
                      <Label className="text-lg font-semibold">Template Style</Label>
                      <TemplateSelector
                        selectedTemplate={community.settings.template}
                        onTemplateChange={(template) => handleSettingsChange("template", template)}
                        community={community}
                      />
                    </div>
                ...
                >
                  <div className="w-full h-full flex items-center justify-center relative overflow-hidden">
                    ...
                    <div
                      ...
                      style={{
                        background:
                          community.settings.template === "modern"
                            ? `linear-gradient(135deg, ${community.settings.primaryColor}20 0%, ${community.settings.secondaryColor}20 100%), linear-gradient(135deg, #0f172a 0%, #1e40af 50%, #3730a3 100%)`
                            : community.settings.template === "creative"
                              ? `linear-gradient(135deg, ${community.settings.primaryColor}30 0%, ${community.settings.secondaryColor}30 100%), linear-gradient(135deg, #7c2d12 0%, #be185d 50%, #ea580c 100%)`
                              : "#ffffff",
                      }}
                    >
                      {/* Background Pattern */}
                      <div className="absolute inset-0 opacity-10">
                        {community.settings.template === "minimal" ? (
                      ...
                      <div className="relative z-10 text-center space-y-3 p-4">
                        ...
                        <div>
                          <h3
                            className={cn(
                              ...
                              community.settings.template === "minimal" ? "text-gray-900" : "text-white",
                            )}
                          >
                            {community.name}
                          </h3>
                          <p
                            className={cn(
                              "opacity-80 max-w-xs mx-auto line-clamp-2",
                              previewDevice === "mobile" ? "text-xs" : "text-xs",
                              community.settings.template === "minimal" ? "text-gray-600" : "text-white",
                            )}
                          >
                        ...
                        <button
                          ...
                          style={{
                            backgroundColor:
                              community.settings.template === "minimal"
                                ? community.settings.primaryColor
                            ...
                            color:
                              community.settings.template === "minimal"
                                ...
                                : community.settings.template === "creative"
                                  ...
                                  : "white",
                            border:
                              community.settings.template === "minimal" ? "none" : "1px solid rgba(255,255,255,0.3)",
                          }}
                        >
                          Join Community
                        </button>
                      ...
                      <div className="absolute top-2 right-2">
                        <Badge
                          ...
                          style={{
                            ...
                            color:
                              community.settings.template === "minimal" ? community.settings.primaryColor : "white",
