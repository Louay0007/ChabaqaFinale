...
export function DashboardSidebar({ user, onLogout }: DashboardSidebarProps) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      section: "communities",
      items: [
        { title: "All Communities", href: "/dashboard/communities", badge: "2" },
        { title: "Create New", href: "/dashboard/communities/create", badge: null },
        { title: "Templates", href: "/dashboard/templates", badge: "12" },
        { title: "Analytics", href: "/dashboard/communities/analytics", badge: null },
      ],
    },
    {
      title: "Content",
    ...
    // },
    {
      ...
      items: [
        { title: "Subscriptions", href: "/dashboard/monetization/subscriptions", badge: null },
        { title: "Courses", href: "/dashboard/monetization/courses", badge: "5" },
        { title: "Products", href: "/dashboard/monetization/products", badge: "12" },
        { title: "Payouts", href: "/dashboard/monetization/payouts", badge: null },
      ],
    },
    {
      title: "Automation",
      ...
      section: "automation",
      items: [
        { title: "Workflows", href: "/dashboard/automation/workflows", badge: "3" },
        { title: "Email Campaigns", href: "/dashboard/automation/emails", badge: null },
        { title: "Welcome Series", href: "/dashboard/automation/welcome", badge: null },
        { title: "Triggers", href: "/dashboard/automation/triggers", badge: null },
      ],
    },
    {
      title: "Integrations",
