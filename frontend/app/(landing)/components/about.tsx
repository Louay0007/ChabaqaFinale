        ...
        >
          ...
          >
            ...
            <div className="w-full max-w-full aspect-video h-auto rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl ring-1 ring-white/10">
              <iframe
                src="https://www.youtube.com/embed/dQw4w9WgXcQ?modestbranding=1&showinfo=0&controls=1&rel=0&iv_load_policy=3&cc_load_policy=0&autoplay=1&mute=0&loop=1&playlist=dQw4w9WgXcQ"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center mb-10 lg:mb-16">
          ...
          <div className="relative order-1 lg:order-none">
            ...
            >
              ...
              <iframe
                src="https://www.youtube.com/embed/dQw4w9WgXcQ?modestbranding=1&showinfo=0&controls=0&rel=0&iv_load_policy=3&cc_load_policy=0&fs=0&disablekb=1&autoplay=1&mute=1&loop=1&playlist=dQw4w9WgXcQ"
