    ...
    <div className="group hover:shadow-lg transition-all duration-300 border border-gray-200/60 rounded-2xl shadow-sm overflow-hidden bg-gradient-to-br from-white to-gray-50/30 hover:scale-[1.01]">
      ...
      <div className="relative w-full aspect-[16/9] mb-1 overflow-hidden rounded-2xl">
        <Image
          ...
          alt={community.name}
          fill
          className="object-cover p-2 rounded-2xl group-hover:scale-105 transition-transform duration-300"
      ...
      <div className="px-3 pb-3 space-y-2">
        ...
        <div className="flex gap-2">
          <div className="flex items-center text-[11px] bg-gray-50 px-2 py-0.5 rounded-full font-medium text-gray-700">
